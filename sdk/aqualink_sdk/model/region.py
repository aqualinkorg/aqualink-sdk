...
class Region(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, polygon, parent, created_at, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, polygon, parent, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """Region - a model defined in OpenAPI
