...
class CreateSurveyDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dive_date, weather_conditions, *args, **kwargs):  # noqa: E501
        """CreateSurveyDto - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, dive_date, weather_conditions, *args, **kwargs):  # noqa: E501
        """CreateSurveyDto - a model defined in OpenAPI
