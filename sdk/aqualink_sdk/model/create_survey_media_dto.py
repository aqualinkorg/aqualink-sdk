...
class CreateSurveyMediaDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, url, observations, survey_point_id, *args, **kwargs):  # noqa: E501
        """CreateSurveyMediaDto - a model defined in OpenAPI
        ...
        Keyword Args:
            quality (float): defaults to 1  # noqa: E501
            featured (bool): defaults to False  # noqa: E501
            hidden (bool): defaults to False  # noqa: E501
            metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): defaults to {}  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, url, observations, survey_point_id, *args, **kwargs):  # noqa: E501
        """CreateSurveyMediaDto - a model defined in OpenAPI
