...
class SiteSurveyPoint(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (float,),  # noqa: E501
            'survey_point_label_id': (float, none_type,),  # noqa: E501
    ...
    attribute_map = {
        'id': 'id',  # noqa: E501
        'survey_point_label_id': 'surveyPointLabelId',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, survey_point_label_id, image_url, name, site_id, polygon, site, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """SiteSurveyPoint - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, survey_point_label_id, image_url, name, site_id, polygon, site, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """SiteSurveyPoint - a model defined in OpenAPI
