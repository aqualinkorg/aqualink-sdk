...
class CreateCollectionDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, user_id, site_ids, *args, **kwargs):  # noqa: E501
        """CreateCollectionDto - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, user_id, site_ids, *args, **kwargs):  # noqa: E501
        """CreateCollectionDto - a model defined in OpenAPI
